...
export default function Home() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 min-h-[600px]">
                  ...
                  <button
                    ...
                    className={`w-full px-4 py-2 text-sm text-left ${
                      index === 0
                        ...
                        : 'text-gray-200 hover:bg-[#1C1E24]/80 hover:text-white'
            ...
            <div className="lg:col-span-4 bg-[#1C1E24]/90 backdrop-blur-sm p-6">
              <div className="flex justify-between items-center mb-4">
                <div className="text-sm text-gray-200">Input:</div>
                <button className="px-3 py-1 text-sm bg-[#15171B]/90 backdrop-blur-sm text-gray-200 rounded hover:text-white transition-colors">
                  Clear
                </button>
              </div>
  ...
  "description": "Sample JSON"
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
        <p className="text-sm text-indigo-300 font-medium tracking-wide uppercase mb-4">
          All your essential tools in one place
        </p>
        <h2 className="text-3xl sm:text-4xl font-bold mb-12 text-white">
          Did we mention Dev Utility Belt is free to use?
        </h2>
